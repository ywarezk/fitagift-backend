...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Answer.icon_class'
        db.add_column(u'fitagift_backend_app_answer', 'icon_class',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Answer.icon_class'
        db.delete_column(u'fitagift_backend_app_answer', 'icon_class')
    ...
    models = {
        u'fitagift_backend_app.answer': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 9, 0, 0)'}),
            ...
            'modified_data': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 9, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),

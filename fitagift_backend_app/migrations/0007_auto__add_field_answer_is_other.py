...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Answer.is_other'
        db.add_column(u'fitagift_backend_app_answer', 'is_other',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Answer.is_other'
        db.delete_column(u'fitagift_backend_app_answer', 'is_other')

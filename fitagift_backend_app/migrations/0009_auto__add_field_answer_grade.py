...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Answer.grade'
        db.add_column(u'fitagift_backend_app_answer', 'grade',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Answer.grade'
        db.delete_column(u'fitagift_backend_app_answer', 'grade')
